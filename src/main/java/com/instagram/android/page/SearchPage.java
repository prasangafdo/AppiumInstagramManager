...
private final By lblUserNames = By.xpath("//android.widget.LinearLayout[contains(@resource-id,'row_search_user_info_container')]");
    ...
    public void searchByUsername(String username){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(txtSearchBar)).clear();
        wait.until(ExpectedConditions.presenceOfElementLocated(txtSearchBar)).sendKeys(username);
